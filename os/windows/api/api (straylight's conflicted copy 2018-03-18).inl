...
namespace windows {
    ...
    HGDIOBJ (WINAPI* const GetStockObject)(OBJ) {
        gdi32.function("GetStockObject")
    };

    DWORD (WINAPI* const SetDCBrushColor)(HDC,DWORD) {
        gdi32.function("SetDCBrushColor")
    };
    ...
    HRESULT (WINAPI* const SetProcessDpiAwareness)(PROCESS_DPI_AWARENESS) {
        shcore.function("SetProcessDpiAwareness")
    };
